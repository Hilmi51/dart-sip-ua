  ...
  void _loadSettings() async {
    ...
    setState(() {
      _wsUriController.text =
          _preferences.getString('ws_uri') ?? 'ws://192.168.254.52:8088/ws';
      _sipUriController.text =
          _preferences.getString('sip_uri') ?? 'sip:1003@192.168.254.52';
      _displayNameController.text =
          _preferences.getString('display_name') ?? '1003';
      _passwordController.text =
          _preferences.getString('password') ?? '1q2w3e4r';
      _authorizationUserController.text =
          _preferences.getString('auth_user') ?? '1003';
    });
  }
